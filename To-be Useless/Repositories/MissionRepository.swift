...
let MediumMission = [
    ...
    Task(title: "Pay attention to breathing for 30 seconds", difficulty: TaskDifficulty.medium, completed: false),
    ...
    Task(title: "Read a page of book", difficulty: TaskDifficulty.medium, completed: false),
